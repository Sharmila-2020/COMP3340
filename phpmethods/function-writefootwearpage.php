...
function writeFootwearPage() {
  include_once "function-findproductbyitemtype.php";
  // create unique product filename
  $producttypehtmlpagename = "../footwear". ".php"; // file will be saved in this location with this name
  $newproducttypehtmlfile = fopen($producttypehtmlpagename,"w"); // creates or overwrites the file
  $producttypehtmlfilecontents = '<?php echo file_get_contents("html/footwearpageheader.html"); ?>';
  ...
  <div class="main-container">
            <div class="main-row">
                ...
                <br/><br/>
                <div class="main-row">
                    <h1>Featured Footwear Products</h1>
                </div>
  ';
  $result = findProductByItemType("footwear");
  ...
  $producttypehtmlfilecontents = $producttypehtmlfilecontents . '<?php echo file_get_contents("html/footwearpagefooter.html"); ?>';
