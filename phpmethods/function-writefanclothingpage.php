...
function writeFanclothingPage() {
  include_once "function-findproductbyitemtype.php";
  // create unique product filename
  $producttypehtmlpagename = "../fanclothing". ".php"; // file will be saved in this location with this name
  $newproducttypehtmlfile = fopen($producttypehtmlpagename,"w"); // creates or overwrites the file
  $producttypehtmlfilecontents = '<?php echo file_get_contents("html/fanclothingpageheader.html"); ?>';
  ...
  <div class="main-container">
            <div class="main-row">
                ...
                <br/><br/>
                <div class="main-row">
                    <h1>Featured Fan Clothing Products</h1>
                </div>
  ';
  $result = findProductByItemType("fanclothing");
  ...
  $producttypehtmlfilecontents = $producttypehtmlfilecontents . '<?php echo file_get_contents("html/fanclothingpagefooter.html"); ?>';
